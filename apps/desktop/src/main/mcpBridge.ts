 ...
 *
 * `services/agent-sidecar/src/arcelle_sidecar/mcp_client.py` is the real, unmodified client this
 * module must satisfy byte-for-byte on the wire —
 * `services/agent-sidecar/tests/test_mcp_bridge_wire_compat.py` runs the two against each
