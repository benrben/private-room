...
const SOURCE = readFileSync(
  join(here, "../../src/workspace/workflows/selectors.ts"),
  "utf8",
);
...
const SHEET = readFileSync(
  join(here, "../../src/workspace/workflows/NodeParamSheet.tsx"),
  "utf8",
);
function lift(name) {
...
test("both places that dot a run status use the one helper", () => {
  ...
  for (const f of ["RunHistory.tsx", "WorkflowLibrary.tsx"]) {
    const src = readFileSync(join(here, "../../src/workspace/workflows/", f), "utf8");
