...
const advisors = read("src/settings/AdvisorsSection.tsx");
const trap = read("src/settings/useFocusTrap.ts");
const privacyHook = read("src/settings/usePrivacy.ts");
const leashHook = read("src/settings/useRoomServer.ts");
const marketplace = read("src/settings/McpMarketplace.tsx");
