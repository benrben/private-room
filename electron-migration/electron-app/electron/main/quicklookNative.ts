 ...
 *      by the process the migration's own design doc prescribes. The
 *      inventory (`pm-request/electron-python-migration-inventory-2026-08-22.md`
 *      §`src/quicklook.rs`) routes this exact module to the Python sidecar
 *      via PyObjC, and that port already exists and is real: read in full,
 *      `sidecar/arcelle_sidecar/media/quicklook.py` calls the SAME
 ...
 *      temp-file discipline, exercised by `sidecar/tests/test_media_quicklook.py`
...
export const NATIVE_RENDER_NOT_IMPLEMENTED =
  ...
  "The already-real port of this capability is sidecar/arcelle_sidecar/media/quicklook.py.";
