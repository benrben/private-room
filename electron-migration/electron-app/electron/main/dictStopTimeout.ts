 ...
 * `sidecar/arcelle_sidecar/stt/dictation.py:314-332` already does for the
 * same reason (its own module docstring §4 explains why the sidecar computes
 * this but does not apply it to itself).
 *
 * ARCHITECTURE (pm-request/electron-python-migration-plan-2026-08-22.md:349):
 * the renderer connects DIRECTLY to `WS /dict/session` for dictation audio —
