 ...
 * even be attempted).
 *
 * SPLIT ACROSS TWO SUBSYSTEMS, per the migration plan
 * (`pm-request/electron-python-migration-inventory-2026-08-22.md` §`preview.rs`
 * and §`quicklook.rs`): the actual pixel-drawing (`quicklook.rs`'s
