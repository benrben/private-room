 ...
 * ============================================================================
 * `pm-request/electron-python-migration-inventory-2026-08-22.md` (the design
 * doc, read but not edited) routes `textutil.rs` to the PYTHON SIDECAR, under
 * its "document parsing goes to Python" split rule. That split does not
 ...
 * already live in `electron/main/*.ts` today. This port follows that same,
 ...
 * `sidecar/arcelle_sidecar/docs/textutil.py`, is explicit about it too
