 ...
 *
 * So this drives the real React app (qa.html, with tests/support/qa-mock.js standing in
 ...
 *
 *   SKIP_BUILD=1 npx wdio run e2e/wdio.capture.conf.mjs --spec tests/visual/browseraudit.mjs
 */
import fs from "node:fs";
import path from "node:path";

const OUT = path.resolve(".artifacts/test-results/capture/browser-audit");
