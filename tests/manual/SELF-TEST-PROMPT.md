...
Companion to `tests/manual/AGENT-PROMPTS.md` (one prompt per agent, for hand-driving) and
`tests/manual/UA-FEATURE-CHECKLIST.md` (the every-button human sheet). This one is for
