...
const zipdocUrl = `data:text/javascript,${encodeURIComponent(transpile("apps/desktop/src/renderer/viewers/zipdoc.ts"))}`;
const epubJs = transpile("apps/desktop/src/renderer/viewers/epub.ts").replaceAll('"./zipdoc"', `"${zipdocUrl}"`);
