...
const SOURCE = readFileSync(join(here, "../../apps/desktop/src/renderer/workspace/recSession.ts"), "utf8");
...
test("the recording view never claims translation stays on this Mac", () => {
  const view = readFileSync(join(here, "../../apps/desktop/src/renderer/viewers/RecordingView.tsx"), "utf8");
