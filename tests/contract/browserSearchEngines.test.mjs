...
const PY = readFileSync(join(root, "services/agent-sidecar/src/arcelle_sidecar/websearch.py"), "utf8");
const TSX = readFileSync(join(root, "apps/desktop/src/renderer/workspace/BrowserSearch.tsx"), "utf8");
