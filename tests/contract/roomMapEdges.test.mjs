...
const constants = await load("apps/desktop/src/renderer/viewers/roomMap/constants.ts");
const edgesSource = readFileSync(join(root, "apps/desktop/src/renderer/viewers/roomMap/edges.ts"), "utf8").replace(
