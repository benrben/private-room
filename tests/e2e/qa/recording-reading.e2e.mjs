...
//
// WHAT THIS SPEC CANNOT SEE. `tests/support/qa-mock.js` stands in for the backend, so the
...
// `services/agent-sidecar/tests/test_rec_read.py` (the prompt, the retry, the skipped window).
