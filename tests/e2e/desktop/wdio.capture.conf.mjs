// WebdriverIO config for the SCREENSHOT CAPTURE run (tests/visual/*.mjs).
//
// Same vehicle as wdio.qa.conf.mjs — the real React app in Chrome against
// dist/qa.html, with tests/support/qa-mock.js standing in for Electron IPC — but the job is
...
export const config = {
  runner: "local",
  specs: [path.join(projectRoot, "tests", "visual", "*.mjs")],
  maxInstances: 1,
