...
def test_the_app_agent_needs_the_screen_verbs_not_just_any_tool_in_its_box() -> None:
    ...
    # Scripts is the other load-bearing box: list-only is inspection, not the
    # advertised ability to run a script.
    scripts = get_agent("scripts.run")
    assert scripts.requires == ("run_script",)
