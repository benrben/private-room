...
The three features shipped 2026-08-07. Companion to `qa/SELF-TEST-PROMPT.md`
(the whole-app agent walk), `qa/AGENT-PROMPTS.md` (hand-driving one agent) and
`qa/UA-FEATURE-CHECKLIST.md` (the every-button human sheet).
